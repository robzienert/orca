...
/**
 * The SpinnakerFileIntent is the root-level element of a .spinnaker file.
 */
@JsonTypeName("SpinnakerFile")
@JsonVersionedModel(currentVersion = "1", propertyName = "kind")
...
data class SpinnakerFileSpec(
  val applications: List<ApplicationSpec>
) : IntentSpec
